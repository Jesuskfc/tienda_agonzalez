 ...
 * @author USUARIO
 */
@WebServlet(name = "SrvComprarAlimentacion", urlPatterns = {"/SrvComprarAlimentacion"})
public class SrvComprarAlimentacion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<td><input type=\"submit\" value=\"Comprar por Precio (Alimentacion) \"></td>");
            out.println("</form>");
            ...
            int familia = 1; //Esta familia corresponde a la alimentación.

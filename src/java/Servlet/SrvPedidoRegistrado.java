 ...
 * @author jesuskfc
 */
@WebServlet(name = "SrvRegistrarPedido", urlPatterns = {"/SrvRegistrarPedido"})
public class SrvPedidoRegistrado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SrvRegistrarPedido</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SrvRegistrarPedido at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<h1>Pedido registrado</h1>");
